...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Group'), array('plugin'=>'UserManagement','controller' => 'Groups','action' => 'edit', $group['Group']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Group'), array('plugin'=>'UserManagement','controller' => 'Groups','action' => 'delete', $group['Group']['id']), null, __('Are you sure you want to delete # %s?', $group['Group']['id'])); ?> </li>
