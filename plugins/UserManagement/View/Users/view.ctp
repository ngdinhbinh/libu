...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit User'), array('plugin'=>'UserManagement','controller' => 'Users','action' => 'edit', $user['User']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete User'), array('plugin'=>'UserManagement','controller' => 'Users','action' => 'delete', $user['User']['id']), null, __('Are you sure you want to delete # %s?', $user['User']['id'])); ?> </li>
